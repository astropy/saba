# -*- coding: utf-8 -*-
#
# saba documentation build configuration file, created by
...
#
saba_release = saba.__version__.split(".dev")[0]
saba_version = saba.__version__
...
# of the sidebar.
html_logo = os.path.join('_static', 'saba_logo.png')
